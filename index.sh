                ...
                <table class="table">
                    ...
                    <tr>
                      ...
                      <tr>
                       <td>
                        Captcha 1</td>
                       <td colspan="2"><img src="http://securityhub.id:2095/image.png?$patch">
                       </td>
                        </tr>
                     <tr>
                        <td>Type Captcha 1 : </td>
                        <td>
                            <input type="cek" name="password" pattern="^[a-zA-Z0-9]+$" title="Captcha." class="form-control">
                        </td>
                    </tr>
